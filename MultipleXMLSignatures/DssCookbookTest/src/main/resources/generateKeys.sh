...
openssl pkcs12 -export -out consumer.p12 -inkey consumer_key.pem -in consumer_signed_cert.pem -certfile ca_signed_cert.pem -passin pass:consumer_key -password pass:consumer_key
...
openssl pkcs12 -export -out provider.p12 -inkey provider_key.pem -in provider_signed_cert.pem -certfile ca_signed_cert.pem -passin pass:provider_key -password pass:provider_key
