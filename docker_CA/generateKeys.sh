...
openssl genpkey -algorithm RSA -pkeyopt rsa_keygen_bits:3072 -out consumer_key.pem -pass pass:consumer_key -aes256
...
openssl genpkey -algorithm RSA -pkeyopt rsa_keygen_bits:3072 -out provider_key.pem -pass pass:provider_key -aes256
...
openssl genpkey -algorithm RSA -pkeyopt rsa_keygen_bits:3072 -out localhost_key.pem -pass pass:localhost_key -aes256
